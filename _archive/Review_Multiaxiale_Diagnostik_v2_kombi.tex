% VERALTET / OUTDATED -- Diese Kombi-Datei ist moeglicherweise NICHT synchron
% mit den aktuellen EN/GER-Versionen (Review_Multiaxiale_Diagnostik_v2_en.tex / _ger.tex).
% Master: EN-Version. Bei Aenderungen immer EN zuerst, dann GER, dann Kombi.
% Stand: 2026-02-21 Quick-Win-Review
...
\noindent\textit{Im Folgenden findet sich eine vollständige deutsche Übersetzung des vorangehenden englischen Artikels.}
...
\date{Februar 2026 --- Version 5 \\ \vspace{0.5em} \small \textit{Wissenschaftliches Review --- Arbeitspapier}}
...
Das vorgestellte 6-Achsen-Modell ist kein R\"uckgriff auf das DSM-IV, sondern repr\"asentiert eine \textbf{genuine Weiterentwicklung}, auf die die psychiatrische Fachwelt selbst konvergiert. Neun Merkmale sind besonders innovativ:
