...
\hypersetup{
    pdftitle={Ein integriertes multiaxiales Modell zur computergest\"utzten psychiatrischen Diagnostik},
    pdfauthor={Lukas Geiger},
    pdfsubject={Methoden- und Design-Paper f\"ur ein 6-Achsen-Entscheidungsunterst\"utzungssystem},
    pdfkeywords={Multiaxiale Diagnostik, DSM-5-TR, ICD-11, ICF, Entscheidungsunterst\"utzung, Abdeckungsanalyse},
    colorlinks=true,
    linkcolor=black,
    urlcolor=blue,
    citecolor=black,
