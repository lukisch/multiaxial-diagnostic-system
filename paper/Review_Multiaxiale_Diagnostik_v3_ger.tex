...
\hypersetup{
    ...
    pdfsubject={Methoden- und Design-Paper fuer ein 6-Achsen-Entscheidungsunterstuetzungssystem},
    pdfkeywords={Multiaxiale Diagnostik, DSM-5-TR, ICD-11, ICF, Entscheidungsunterstuetzung, Abdeckungsanalyse},
    unicode=true,
    colorlinks=true,
    linkcolor=black,
    urlcolor=blue,
...
Bei der Erstellung dieses Manuskripts wurden KI-gest\"utzte Werkzeuge als nicht-autorschaftliche Hilfsmittel eingesetzt:

\begin{description}[style=nextline, leftmargin=2cm]
\item[\textbf{Claude Opus 4.6} (Anthropic)] Unterst\"utzung bei Literaturorganisation, Textstrukturierung, \"Ubersetzung, Formulierung, Konsistenzpr\"ufung und iterativer Designpr\"ufung. Dies stellte keine unabh\"angige wissenschaftliche Validierung dar; alle inhaltlichen Entscheidungen wurden vom menschlichen Autor getroffen und verantwortet.
\item[\textbf{Gemini} (Google DeepMind) \& \textbf{Copilot} (Microsoft)] Erg\"anzende Konsistenzpr\"ufungen und Unterst\"utzung bei der Literaturrecherche. Ausgaben wurden als Vorschl\"age behandelt, die menschliche Bewertung erfordern.
\end{description}

\noindent Die inhaltliche Konzeption, wissenschaftliche Argumentation und Verantwortung f\"ur den gesamten Inhalt liegen ausschlie\ss{}lich beim Autor. Gem\"a\ss{} ICMJE- und COPE-Richtlinien erf\"ullen KI-Systeme nicht die Kriterien f\"ur Autorenschaft. Sie sind weder Autoren noch Koautoren, keine Danksagungsempf\"anger, keine Wahrheits- oder Ground-Truth-Instanzen und keine unabh\"angigen Validierungsinstanzen; sie tragen keine Verantwortung f\"ur das Manuskript.
...
\textbf{Phase~3: Prototypische Implementierung.} Eine Python-Referenzimplementierung (ca.\ 1.850~Zeilen) unter Verwendung hierarchischer Zustandsmaschinen (\texttt{transitions}-Bibliothek) und einer Streamlit-Oberfl\"ache wurde entwickelt, um die Machbarkeit zu demonstrieren. Der Quellcode ist im \href{https://github.com/research-line/multiaxial-diagnostic-system}{Projekt-Repository auf GitHub} \"offentlich verf\"ugbar.

\textbf{Phase~4: KI-gest\"utzte Entwicklung und Review.} Manuskript und Systemdesign wurden vom Autor mit substanzieller KI-gest\"utzter Werkzeugunterst\"utzung entwickelt (Claude Opus 4.6 f\"ur Strukturierungs- und Formulierungshilfe; Gemini und Copilot f\"ur Konsistenzpr\"ufungen und Unterst\"utzung bei der Literaturrecherche). Die KI-Nutzung ist im Abschnitt zur Nutzung KI-gest\"utzter Werkzeuge dokumentiert. Die wissenschaftliche Verantwortung f\"ur alle Inhalte liegt beim menschlichen Autor.
...
\footnotesize
\begin{longtable}{@{}L{1.8cm}L{2.4cm}L{5.0cm}L{4.0cm}@{}}
...
Das vorliegende System bevorzugt \textbf{ausschlie\ss{}lich frei verf\"ugbare Instrumente}; der proprietaere CBCL/YSR-Komplex \citep{Achenbach2001} wird zwar als Referenzstandard anerkannt, aber durch lizenzfreie Alternativen ersetzt. Tabelle~\ref{tab:instrumente_kj} listet die empfohlene Auswahl freier K/J-Instrumente parallel zur Erwachsenenmatrix (Tabelle~\ref{tab:instrumente}).

\footnotesize
\begin{longtable}{@{}L{2.4cm}L{2.4cm}L{0.9cm}L{1.5cm}L{2.0cm}L{1.5cm}@{}}
\caption{Freie Screening-Instrumente f\"ur Kinder und Jugendliche (K/J-Matrix)} \label{tab:instrumente_kj} \\
\toprule
...
\footnotesize
\begin{longtable}{@{}L{2.4cm}L{2.0cm}L{0.9cm}L{1.8cm}L{2.2cm}L{1.1cm}@{}}
