...
\textbf{Phase~3: Prototypical implementation.} A Python reference implementation (approx.\ 1,850~lines) using hierarchical state machines (\texttt{transitions} library) and a Streamlit interface was developed to demonstrate feasibility. The source code is publicly available at \url{https://github.com/research-line/multiaxial-diagnostic-system}.
...
\begin{center}
\url{https://github.com/research-line/multiaxial-diagnostic-system}
\end{center}
