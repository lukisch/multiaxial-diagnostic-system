...
\textbf{Phase~3: Prototypical implementation.} A Python reference implementation (approx.\ 1,850~lines) using hierarchical state machines (\texttt{transitions} library) and a Streamlit interface was developed to demonstrate feasibility. The source code is publicly available in the \href{https://github.com/research-line/multiaxial-diagnostic-system}{project repository on GitHub}.
...
\begin{longtable}{@{}p{0.75cm}p{2.05cm}p{3.25cm}p{3.75cm}p{1.85cm}@{}}
...
\begin{center}
\href{https://github.com/research-line/multiaxial-diagnostic-system}{github.com/research-line/multiaxial-diagnostic-system}
\end{center}
