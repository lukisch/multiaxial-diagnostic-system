...
AI-assisted tools were used as non-authorial support tools during the preparation of this manuscript:

\begin{description}[style=nextline, leftmargin=2cm]
\item[\textbf{Claude Opus 4.6} (Anthropic)] Support for literature organization, text structuring, translation assistance, drafting assistance, consistency checks, and iterative design review. This did not constitute independent scientific validation; all substantive decisions were made and are the responsibility of the human author.
\item[\textbf{Gemini} (Google DeepMind) \& \textbf{Copilot} (Microsoft)] Supplementary consistency checks and literature-search support. Outputs were treated as suggestions requiring human assessment.
\end{description}

\noindent The conceptual design, scientific argumentation, and responsibility for the entire content lie exclusively with the author. In accordance with ICMJE and COPE guidelines, AI systems do not meet the criteria for authorship. They are not authors or co-authors, were not used as acknowledgement recipients, ground-truth authorities, or independent validators, and do not bear responsibility for the manuscript.
...
\textbf{Phase~4: AI-assisted development and review.} Manuscript and system design were developed by the author with substantial AI-assisted tool support (Claude Opus 4.6 for structuring and drafting assistance; Gemini and Copilot for consistency checks and literature-search support). All AI tool use is documented in the AI usage declaration section. The scientific responsibility for all content lies with the human author.
...
\caption{Free screening instruments for children and adolescents (C/A matrix)} \label{tab:instrumente_ca} \\
\toprule
...
\footnotesize
\begin{longtable}{@{}L{2.4cm}L{2.0cm}L{0.9cm}L{1.6cm}L{2.5cm}L{1.1cm}@{}}
